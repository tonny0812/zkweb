...
import com.keepgulp.zkweb.model.Tree;
import com.keepgulp.zkweb.model.TreeRoot;
...
public class ZkController implements DisposableBean{
	...
	public @ResponseBody List<ZkManager.PropertyPanel> queryZKJMXInfo(
...
//			//model.addAttribute("path",path);
//			model.addAttribute("cacheId", cacheId);
			List<ZkManager.PropertyPanel> result=ZkCache.get(cacheId).getJMXInfo(Integer.parseInt(simpleFlag)==0?false:true);
